...
Covariance means you can use a more derived type (subtype), while contravariance means you can use a more basic type (supertype).
...
This indicates that the function has no side effects and its result depends only on its inputs.
