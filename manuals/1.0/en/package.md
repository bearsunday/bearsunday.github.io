...
```bash
php -S 127.0.0.1:8080 bin/app.php # PHP server
```
...
To place them outside the project tree, declare them with `ReadOnlyAppModule` ([Production](production.html#writable-paths)).
