...
BEAR.Sunday's distinctive technologies and features are described in the following chapters.
...
* [Value Brought by BEAR.Sunday](#value-brought-by-bearsunday)
...
Sunday is a framework designed in the principles and spirit of the Web, empowering developers to build flexible and robust applications by providing clear constraints based on principles.
