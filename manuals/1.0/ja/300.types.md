...
2. [複合型](#複合型)
   - [ユニオン型](#ユニオン型)
   - [交差型](#交差型)
3. [高度な型システムと使用パターン](#高度な型システムと使用パターン)
   - [ジェネリック型](#ジェネリック型)
   - [テンプレート型](#テンプレート型)
   - [条件付き型](#条件付き型)
   - [型エイリアス](#型エイリアス)
   ...
   - [共変性と反変性](#共変性と反変性)
   - [型の演算子](#型の演算子)
   - [デザインパターンでの型の使用](#デザインパターンでの型の使用)
4. [ユーティリティ型](#ユーティリティ型)
5. [関数型プログラミングの概念](#関数型プログラミングの概念)
   - [純粋関数](#純粋関数)
   - [不変オブジェクト](#immutableオブジェクト)
   - [副作用の注釈](#副作用の注釈)
   - [高階関数](#高階関数)
6. [アサート注釈](#アサート注釈)
7. [セキュリティ注釈](#セキュリティ注釈)
...
ユーティリティ型は[高度な型システム](#高度な型システムと使用パターン)の一部として考えることができます。
...
ないこと、そして関数の結果が入力のみに依存することを明示できます。
...
PHPDocの型システムを深く理解して適切に使用することで、コードの自己文書化、静的解析による早期のバグ検出、IDEによる強力なコード補完と支援、コードの意図と構造の明確化、セキュリティリスクの現象などの利点が得られ、より堅牢で保守性の高いPHPコードを書くことができます。
