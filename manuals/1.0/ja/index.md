...
BEAR.Sundayの目標は、高品質でAPI中心のWebアプリケーションのためのフレームワークを提供することです。アプリケーションをRESTfulな構造で設計し、標準や原則を重視する事で開発効率や継続性を向上させます。小規模なコンソールアプリケーションから大規模なCMSシステムまで、幅広い用途に対応します。
