...
[tutorial1](https://github.com/bearsunday/tutorial1/commits/v2-php8.3)のコミットを参考にして進めましょう。
...
[^1]:このプロジェクトのソースコードは各セクション毎に[bearsunday/Tutorial](https://github.com/bearsunday/tutorial1/commits/v2-php8.3)にコミットしています。適宜参照してください。
