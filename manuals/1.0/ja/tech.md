...
揮発しない永続的なコンテンツをCDNに置くため、SPOF（Single Point of Failure）を避けられ、可用性と耐障害性が上がります。ダイナミックコンテンツもスタティックコンテンツと同じようにWeb本来の分散キャッシュに乗るので、ユーザー体験とコスト効率の両方が改善します。Webが1990年代から持っていた、スケーラブルでネットワークコストを下げる分散キャッシュという原則を、現代の技術で使い直すものです。
