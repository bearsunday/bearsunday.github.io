...
| Command | Description |
|---|---|
| `./bin/serve_local.sh` | Local dev: generates LLMs.txt, then serves with watch mode on port 4001 |
...
3. Verify generated files (LLMs.txt) are not committed — they are build artifacts.
